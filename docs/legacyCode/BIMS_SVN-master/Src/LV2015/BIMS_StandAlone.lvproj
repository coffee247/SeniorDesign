	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="System" Type="Folder">
			<Item Name="Message Center" Type="Folder">
				<Item Name="MC - Create INI.vi" Type="VI" URL="../Message Center/MC - Create INI.vi"/>
				<Item Name="MC - Fill Default Values.vi" Type="VI" URL="../Message Center/MC - Fill Default Values.vi"/>
				<Item Name="MC - Get Data From Key Value.vi" Type="VI" URL="../Message Center/MC - Get Data From Key Value.vi"/>
				<Item Name="MC - Read INI.vi" Type="VI" URL="../Message Center/MC - Read INI.vi"/>
				<Item Name="MC - String To Date.vi" Type="VI" URL="../Message Center/MC - String To Date.vi"/>
				<Item Name="MC - Test Date String.vi" Type="VI" URL="../Message Center/MC - Test Date String.vi"/>
				<Item Name="MC - Test Interval String.vi" Type="VI" URL="../Message Center/MC - Test Interval String.vi"/>
				<Item Name="MC - Test Key Names.vi" Type="VI" URL="../Message Center/MC - Test Key Names.vi"/>
				<Item Name="MC - Test Message String.vi" Type="VI" URL="../Message Center/MC - Test Message String.vi"/>
				<Item Name="Ballistics Message Center.vi" Type="VI" URL="../Ballistics Message Center.vi"/>
			</Item>
			<Item Name="Counter-Timer (NI 6602)" Type="Folder">
				<Item Name="NI-TIO" Type="Folder">
